...
public class VendaDao { 
    ...
    private String adicionar(Venda venda) {
        ...
        try {
            ...
            return resultado == 1 ? "Venda adicionada com sucesso!" : "Nao foi possivel adicionar a venda";
    ...
    public List<Venda> buscarVendas() {
        ...
        try {
            ResultSet resultSet = conexao.obterConexao().prepareStatement(sql).executeQuery(sql);
